...
use Nicy\Support\Optional;
use Nicy\Support\Collection;
use Nicy\Support\Contracts\Htmlable;
...
if (! function_exists('e')) {
     ...
     *
     * @param \Nicy\Support\Contracts\Htmlable|string $value
...
if (! function_exists('tap')) {
    ...
    {
        if (is_null($callback)) {
            return new Nicy\Support\HigherOrderTapProxy($value);
        }
